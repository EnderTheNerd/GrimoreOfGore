package net.ender.grimoire_of_gore.spells;
...
public class PactOfTheDeadSpell extends AbstractSpell {
        ...
        private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID, "pact_of_the_dead");
