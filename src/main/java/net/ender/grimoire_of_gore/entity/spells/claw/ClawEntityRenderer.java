...
public class ClawEntityRenderer extends EntityRenderer<ClawEntity> {
    ...
    private static final ResourceLocation[] TEXTURES = {
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID, "textures/entity/claw/claw_1.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID,"textures/entity/claw/claw_2.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID,"textures/entity/claw/claw_3.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID, "textures/entity/claw/claw_4.png")
    };
