package net.ender.grimoire_of_gore.entity.spells.bone_claw;
...
public class BoneClawEntityRenderer extends EntityRenderer<BoneClawEntity> {
    ...
    private static final ResourceLocation[] TEXTURES = {
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID, "textures/entity/bone_claw/soul_claw_1.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID,"textures/entity/bone_claw/soul_claw_2.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID,"textures/entity/bone_claw/soul_claw_3.png"),
            ResourceLocation.fromNamespaceAndPath(GrimoireOfGore.MOD_ID, "textures/entity/bone_claw/soul_claw_4.png")
    };
