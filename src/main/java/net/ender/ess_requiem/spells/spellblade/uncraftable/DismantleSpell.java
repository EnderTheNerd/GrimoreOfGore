...
public class DismantleSpell extends AbstractSpell {
        ...
        private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(EndersSpellsAndStuffRequiem.MOD_ID, "dismantle");
        ...
        public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
            ...
            DismantleProjectile mantle = new DismantleProjectile(level, entity);
            mantle.setPos(entity.getEyePosition());
            mantle.shoot(entity.getLookAngle());
            mantle.setDamage(getDamage(spellLevel, entity)/2);
            level.addFreshEntity(mantle);
        }
