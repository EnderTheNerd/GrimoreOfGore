...
public class SoulmasterSwordRenderer extends GeoEntityRenderer<SummonedWeaponEntity> {

    public SoulmasterSwordRenderer(EntityRendererProvider.Context renderManager, Supplier<GeoModel<SummonedWeaponEntity>> model) {
